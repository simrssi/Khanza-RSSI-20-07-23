                ...
                if((!Kd2.getText().equals(""))&&(!Petugas.getText().equals(""))){
                     try {
                        ...
                        try {
                            ...
                            while(rs.next()){
                                htmlContent.append("<tr><td border='0' align='center'><a href='"+rs.getString("lokasi_gambar")+"'><img src='"+rs.getString("lokasi_gambar")+"' alt='photo' width='"+(internalFrame1.getWidth()-370)+"' height='"+(internalFrame1.getWidth()-370)+"'/></a></td></tr>");
                            }
                            LoadHTML.setText(
                                "<html>"+
