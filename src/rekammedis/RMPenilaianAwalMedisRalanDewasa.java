...
public final class RMPenilaianAwalMedisRalanDewasa extends javax.swing.JDialog {
    ...
    */
    ...
    private void isRawat() {
        ...
        if(Sequel.cariInteger("select count(no_rawat) from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter ")>0){ 
            Suhu.setText(Sequel.cariIsi("select suhu_tubuh from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter ")); 
            TD.setText(Sequel.cariIsi("select tensi from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter ")); 
            BB.setText(Sequel.cariIsi("select berat from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter ")); 
            TB.setText(Sequel.cariIsi("select tinggi from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter ")); 
            Nadi.setText(Sequel.cariIsi("select nadi from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter ")); 
            RR.setText(Sequel.cariIsi("select respirasi from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            SPO.setText(Sequel.cariIsi("select spo2 from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            GCS.setText(Sequel.cariIsi("select gcs from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            RR.setText(Sequel.cariIsi("select respirasi from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            RPS.setText(Sequel.cariIsi("select keluhan from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            KetFisik.setText(Sequel.cariIsi("select pemeriksaan from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            KetLokalis.setText(Sequel.cariIsi("select pemeriksaan from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            Diagnosis.setText(Sequel.cariIsi("select penilaian from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            Penunjang.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            Konsul.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            Tatalaksana.setText(Sequel.cariIsi("select instruksi from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
            Alergi.setText(Sequel.cariIsi("select alergi from pemeriksaan_ralan inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
           }
    }
