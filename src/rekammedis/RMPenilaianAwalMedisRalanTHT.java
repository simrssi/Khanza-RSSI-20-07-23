...
//            Konsul.setText(Sequel.cariIsi("select rtl from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()));
            Tatalaksana.setText(Sequel.cariIsi("select instruksi from inner join dokter on pemeriksaan_ralan.nip=dokter.kd_dokter where no_rawat='"+TNoRw.getText()+"'and pemeriksaan_ralan.nip=dokter.kd_dokter "));
